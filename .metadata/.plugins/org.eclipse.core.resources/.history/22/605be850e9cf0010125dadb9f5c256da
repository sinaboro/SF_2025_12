...
public class HelloController {
	...
	//localhost:8080/sample/ex2 -> void : /WEB-INF/views/sample/ex2.jsp
	@GetMapping("/ex2")
	public void ex2() {
		log.info("/sample/ex2");
	}
	
	//localhost:8080/sample/ex3 -> String : /WEB-INF/views/ex3.jsp
	@GetMapping("/ex3")
	public String ex3() {
		return "ex3";
	}

	//localhost:8080/sample/ex4 -> String : /WEB-INF/views/board/ex4.jsp
	@GetMapping("/ex4")
	public String ex4() {
		return "board/ex4";
	}
